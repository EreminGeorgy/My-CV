const DICTIONARY = {
	en: {
		...
		profile: 'Profile',
		profile_description: 'Proactive and motivated front-end developer with engineering background and experience in creating single page applications and mobile friendly websites using ES6+, modern js frmeworks and Webpack. Born on November 11th 1989. Worked as a mechanical engineer for 7 years, as a researcher for 3 years and for 5 years as a teacher. Started working as a front-end developer in 2018.',
		skills: 'Skills',
